...
class Util {
    /**
        ...
        (If it is present more than once, it will cause the entire expression not to match,
        which in the parser will result in an `InvalidExpression` error)
    ...
    **/
    public static function constructMatcher(mod:String, param:String = "[0-9]*") : String {
